...
public class FacultyListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        android.widget.Button btnExport = findViewById(R.id.btnExportCsv);
        btnExport.setOnClickListener(v -> startActivity(new android.content.Intent(FacultyListActivity.this, ExportActivity.class)));
